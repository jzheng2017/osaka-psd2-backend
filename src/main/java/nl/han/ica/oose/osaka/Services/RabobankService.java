...
public class RabobankService {
    ...
    public ResponseEntity<String> getUserAccounts(String token) throws IOException, GeneralSecurityException {
    ...
    public ResponseEntity<String> getAccountBalances(String token, String id) throws IOException, GeneralSecurityException {
        var headers = getHeaders(token);
        var request = new RequestEntity(headers, HttpMethod.GET, URI.create(API_BASE+"/accounts/"+id+"/balances"));
        return template.exchange(request, String.class);
    }

    public ResponseEntity<String> getAccountTransactions(String token, String id) throws IOException, GeneralSecurityException {
        var headers = getHeaders(token);
