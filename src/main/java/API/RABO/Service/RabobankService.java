...
public class RabobankService {
    ...
    public String checkEnoughBalance(String token) {
        return doPostRequest(AF_BASE, "", token, "");
    }

    private String doRequest(HttpMethod method, String base, String endpoint, String token, String payload) {
    ...
    private String doGetRequest(String base, String endpoint, String token) {
        return doRequest(HttpMethod.GET, base, endpoint, token, "");
    }

    private String doPostRequest(String base, String endpoint, String token, String payload) {
        return doRequest(HttpMethod.POST, base, endpoint, token, payload);
    }
